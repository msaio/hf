...
select yn in "Yes" "No"; do
	case $yn in
		Yes )
			...
			curl -fLo ~/.config/nvim/init.vim https://raw.githubusercontent.com/msaio/hf/master/U18.04/nvim/init.vim
			curl -fLo ~/.config/nvim/plugin.vim https://raw.githubusercontent.com/msaio/hf/master/U18.04/nvim/plugin.vim
			curl -fLo ~/.config/nvim/personal.vim https://raw.githubusercontent.com/msaio/hf/master/U18.04/nvim/personal.vim
			curl -fLo ~/.config/nvim/theme.vim https://raw.githubusercontent.com/msaio/hf/master/U18.04/nvim/theme.vim
			# 4th, install plugin
		...
		Yes )
			...
			case $shell in
				bash_it )
					...
					# 3rd, get public config file from github.com/msaio
					curl -fLo ~/.bashrc https://raw.githubusercontent.com/msaio/hf/master/U18.04/bash/.bashrc
...
select yn in "Yes" "No"; do
	case $yn in
		Yes )
			...
			curl -fLo ~/.tmux.conf https://raw.githubusercontent.com/msaio/hf/master/U18.04/tmux/.tmux.conf
			curl -fLo ~/.tmux.conf.local https://raw.githubusercontent.com/msaio/hf/master/U18.04/tmux/.tmux.conf.local
			break
			;;
		No  )
			break
